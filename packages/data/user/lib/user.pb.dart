...
/// Additional message formats for requests and responses
...
class UpdateUserRequest extends $pb.GeneratedMessage {
  ...
  factory UpdateUserRequest.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
...
class UserResponse extends $pb.GeneratedMessage {
  ...
  factory UserResponse.fromBuffer(
    $core.List<$core.int> i, [
    $pb.ExtensionRegistry r = $pb.ExtensionRegistry.EMPTY,
  ]) =>
      create()..mergeFromBuffer(i, r);
...
class UserServiceApi {
  ...
  $async.Future<User> readUser($pb.ClientContext? ctx, UserId request) =>
      _client.invoke<User>(ctx, 'UserService', 'ReadUser', request, User());
  ...
  $async.Future<UserResponse> deleteUser(
    $pb.ClientContext? ctx,
    UserId request,
  ) =>
      _client.invoke<UserResponse>(
